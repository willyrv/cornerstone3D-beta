...
/**
 * AiLineTool let you draw annotations that measures the length of two drawing
 * points on a slice. You can use the AiLineTool in all imaging planes even in oblique
 ...
 *
 * ```js
 * cornerstoneTools.addTool(AiLineTool)
 *
 * const toolGroup = ToolGroupManager.createToolGroup('toolGroupId')
 *
 * toolGroup.addTool(AiLineTool.toolName)
 *
 * toolGroup.addViewport('viewportId', 'renderingEngineId')
 *
 * toolGroup.setToolActive(AiLineTool.toolName, {
 *   bindings: [
 *    {
...
class AiLineTool extends AnnotationTool {
  static toolName;
  ...
  addNewAnnotation = (
    ...
    //console.log('doing new annotation');
...
AiLineTool.toolName = 'AiLine';
export default AiLineTool;
